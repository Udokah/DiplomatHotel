...
<!-- box end -->
  ...
  <tr>
    <td><div align="right">Exchange Rate</div></td>
  ...
  <tr>
	...
	<?php
	$clientname = $_POST['name'].' '.$_POST['last'] ;
	?>
<form action="https://41.203.113.80/globalpay_demo/paymentgatewaycapture.aspx" method="post" name="paymentform">
	...
	<input type="hidden" name="names" value="<?php echo $clientname ; ?>" />
	...
	<input type="hidden" name="phone_number" value="<?php echo $_POST['cnumber']; ?>" />
