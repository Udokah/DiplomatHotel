...
<head>
<title>Services - Diplomat Hotels</title>
...
<!-- End WOWSlider.com BODY section -->
					...
					<div class="inner">
						<ul class="nav">
							...
							<li><a href="accomadations.php" class="current">Accomodations</a></li>
						</ul>
					</div>
				</div>
<!-- header-box end -->
...
<!-- box end -->
			...
			<div class="content">
				<div class="indent">
					...
					<div class="container">
						<div class="col-1">
				 			<img alt="" src="dhimg/executive.jpg" class="extra-img png"/>
							<dl class="list1">
								<dt>Deluxe Room</dt>
								<dd class="last"><span>$200</span>Price:</dd>
							</dl>
						</div>
						<div class="col-2">
					 		<img alt="" src="dhimg/deluxe.jpg" class="extra-img png"/>
							<dl class="list1">
								<dt>Juniour Suites</dt>
		
								<dd class="last"><span>$300</span>Price:</dd>
							</dl>
						</div>
						<div class="col-3">
					 		<img alt="" src="dhimg/junior.jpg" class="extra-img png"/>
							<dl class="list1">
								<dt>Executive Suites</dt>
								<dd class="last"><span>$400</span>Price:</dd>
							</dl>
						</div>
						<div class="clear"></div>
					</div>
